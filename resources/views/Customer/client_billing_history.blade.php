...
<div class="mx-0 py-5 px-3 mx-ns-4 bg-gradient-primary">
     ...
     <h3><b>{{$billingList->meter_serial_number}}</b> - {{$billingList->lastname}}, {{$billingList->firstname}}</h3>
	...
	<div class="col-lg-10 col-md-11 col-sm-11 col-xs-11">
		<div class="card rounded-0 shadow">
				...
				<div class="container-fluid">
                    <table class="table table-hover table-striped table-bordered" id="list">
                        ...
                        <tbody>         
                            ...
                            @foreach ($billingList->billingList as $record)
                                <tr>
			...
			<div class="card-footer py-1 text-center">
				<a class="btn btn-light btn-sm bg-gradient-light border rounded-0" href="{{ route('user')}}"><i class="fa fa-angle-left"></i> Back </a>
			</div>
		</div>
	</div>
</div>
