	...
	<div class="col-lg-10 col-md-11 col-sm-11 col-xs-11">
		<div class="card rounded-0 shadow">
				...
				<div class="container-fluid">
					<div class="container-fluid" id="printout">
						<div class="row">
							...
							<div class="col-lg-4 col-md-5 col-sm-12 col-xs-12 py-3 font-weight-bolder border">Penalty</div>
							<div class="col-lg-8 col-md-7 col-sm-12 col-xs-12 py-3 border">{{$billing->penalty}}</div>
			...
			<div class="card-footer py-1 text-center">
				...
				<a class="btn btn-light btn-sm bg-gradient-light border rounded-0" href="{{route('adminadd_billing')}}"><i class="fa fa-angle-left"></i> Create New Bill</a>
			</div>
		</div>
	</div>
</div>
