	...
	<div class="col-lg-10 col-md-11 col-sm-11 col-xs-11">
		<div class="card rounded-0 shadow">
			...
			<div class="card-footer py-1 text-center">
				...
				<a class="btn btn-light btn-sm bg-gradient-light border rounded-0" href="{{ url('cashieradd_billing').'/'.$billing->id}}./?page=billings"><i class="fa fa-angle-left"></i> Back to List</a>
