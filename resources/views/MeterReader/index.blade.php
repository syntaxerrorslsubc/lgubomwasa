      ...
      <nav class="main-header navbar navbar-expand navbar-light shadow text-sm">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item d-none d-sm-inline-block">
            <a href="{{route('login')}}" class="nav-link">BOMWASA Water Billing System - Meter Reader</a>
          </li>
        </ul>
        <!-- Right navbar links -->
          ...
          <li class="nav-item">
            <div class="btn-group nav-link">
                  ...
                  <div class="dropdown-menu" role="menu">
                    ...
                    <a class="dropdown-item" href="{{ route('login') }}"><span class="fas fa-sign-out-alt"></span> Logout</a>
                  </div>
              </div>
          </li>
          <li class="nav-item">
              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item dropdown">
                      <a href="http://localhost/wbms/admin/?page=category" class="nav-link nav-category">
