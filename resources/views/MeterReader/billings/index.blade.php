...
<div class="card card-outline rounded-0 card-navy">
  <div class="card-header">
    ...
    <div class="card-tools">
      <a href="{{route('meterreaderadd_billing')}}" id="create_new" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  Create New</a>
    </div>
  </div>
  <div class="card-body">
                ...
                <td align="center">
                   <button type="button" class="btn btn-flat p-1 btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
                            ...
                            <div class="dropdown-menu" role="menu">
                              <a class="dropdown-item view_data" href="{{ url('/meterreader/view_billing/').'/'.$billing_list->id}}"><span class="fa fa-eye text-dark"></span> View</a>
                              <div class="dropdown-divider"></div>
                              <a class="dropdown-item edit_data" href="{{ url('/meterreader/edit_billing/').'/'.$billing_list->id}}"><span class="fa fa-edit text-primary"></span> Edit</a>
                            <div class="dropdown-divider"></div>
                              <a class="dropdown-item delete_data" data-url="{{ url('/meterreader/delete_billing/').'/'.$billing_list->id}}" href=""><span class="fa fa-trash text-danger"></span> Delete</a>
                            </div>
                </td>
              </tr>
